...
function MyOffices() {
  ...
  const viewRezervations = (id) => {
    history.push(`/view-reservations/${id}`);
  };
      ...
      <div className="p-4 mb-4 rounded text-bg-dark">
        <div className="col-md-5 px-0">
          <h1 className="display-6 fst-italic">
            Bine ați venit {sessionStorage.getItem("user_name")} !<br />
            ...
            >
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="btn-group">
                    <button
                      ...
                      onClick={() => viewRezervations(office.id)}
                    >
                      Rezervări
                    </button>
                    <button
              ...
              >
                {office.images ? (
                  <>
                    <img
                      className="card-img card_main rounded-end"
                  ...
                  <>
                    <img
                      alt="no images found"
                      className="card-img card_main rounded-start"
                      style={{ objectFit: "cover", height: "248px" }}
